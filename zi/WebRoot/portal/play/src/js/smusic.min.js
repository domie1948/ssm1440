! function(a) {
	...
	function his(id){
		$.getJSON('/player/user/his_post.jsp', {mid:id}, function(data, status) {
			 });
    ...
    j.prototype = {
        ...
        init: function() {
            ...
            }, this.currentMusic = this.config.defaultIndex || 0, this.playMode = 1, this.audioDom = document.getElementById('audio'), this.createListDom(), this.initPlay(), this.action()
        }
